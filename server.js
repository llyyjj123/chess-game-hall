...
核心策略（按优先级）：
1. 必须防守：对手有冲四（连续4子且一端开放）时，必须堵住
2. 优先进攻：自己能形成活四（4子连续两端开放）就下
3. 制造双三：同时形成两个活三是必胜局面
4. 进攻要连续：尽量形成连续威胁让对手疲于防守

常见棋型识别：
- 活四：_XXXX_ （两端空，必胜）
- 冲四：OXXXX_ 或 _XXXXO （一端堵住，必须防守）
- 活三：_XXX_ （两端空，强威胁）
- 眠三：OXXX_ 或 _XXXO （一端堵住）
- 活二：_XX_ （两端空，发展中）

分析每个方向（横、竖、两条对角线）的棋型。
